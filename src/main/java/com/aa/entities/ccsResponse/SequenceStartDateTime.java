/**
 * @author rswami
 * POJO to get sequence start date and time details from CCS service
 */
...
public class SequenceStartDateTime {
    ...
    public void setFormattedLocalTime(final String formattedLocalTime) {
        this.formattedLocalTime = SequenceDateUtil.formatSequenceDateTimeString(formattedLocalTime);
    }
    ...
    public void setFormattedGmt(final String formattedGmt) {
        this.formattedGmt = SequenceDateUtil.formatSequenceDateTimeString(formattedGmt);
    }
    ...
    public void setFormattedBaseTime(final String formattedBaseTime) {
        this.formattedBaseTime = SequenceDateUtil.formatSequenceDateTimeString(formattedBaseTime);
    }

    @Override
    public String toString() {
        return "SequenceStartDateTime [additionalProperties=" + additionalProperties + ", baseTime=" + baseTime
                + ", formattedBaseTime=" + formattedBaseTime + ", formattedGmt=" + formattedGmt
                + ", formattedLocalTime=" + formattedLocalTime + ", gmt=" + gmt + ", localTime=" + localTime + "]";
    }
