/**
 * @author rswami
 * POJO to get start date and time details from CCS service
 */
...
public class SequenceEndDateTime {
    ...
    public String toString() {
        return "SequenceEndDateTime [localTime=" + localTime + ", formattedLocalTime=" + formattedLocalTime + ", gmt="
                + gmt + ", formattedGmt=" + formattedGmt + ", baseTime=" + baseTime + ", formattedBaseTime="
